...
const components_mpHtml_search_index = require("./search/index.js");
const components_mpHtml_style_index = require("./style/index.js");
const node = () => "./node/node.js";
const plugins = [components_mpHtml_markdown_index.Markdown, components_mpHtml_emoji_index.Emoji, components_mpHtml_highlight_index.Highlight, components_mpHtml_search_index.Search, components_mpHtml_style_index.Style];
const _sfc_main = {
  name: "mp-html",
  data() {
    return {
