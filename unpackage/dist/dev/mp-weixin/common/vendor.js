...
(function(exports2) {
  ...
  const detect = (buffer2) => {
    const matches = (0, exports2.analyse)(buffer2);
    return matches.length > 0 ? matches[0].name : null;
  };
  exports2.detect = detect;
  const analyse = (buffer2) => {
    if (!(0, utils_1.isByteArray)(buffer2)) {
    ...
    const context = {
      ...
      c1Bytes,
      rawInput: buffer2,
      rawLen: buffer2.length,
      inputBytes: buffer2,
      inputLen: buffer2.length
    };
  ...
  const detectFile = (filepath, opts = {}) => new Promise((resolve2, reject) => {
    let fd;
    ...
    const handler = (err, buffer2) => {
      ...
      if (err) {
        ...
        resolve2((0, exports2.detect)(buffer2));
      }
    };
...
(function(module2) {
  (function(global2) {
    if (module2.exports && !global2["encoding-indexes"]) {
    ...
    function GB18030Decoder(options) {
      ...
      this.handler = function(stream, bite) {
        ...
        if (gb18030_third !== 0) {
          ...
          var buffer2 = [gb18030_second, gb18030_third, bite];
          gb18030_first = 0;
          gb18030_second = 0;
          gb18030_third = 0;
          if (code_point === null) {
            stream.prepend(buffer2);
            return decoderError(fatal);
          }
          return code_point;
        }
